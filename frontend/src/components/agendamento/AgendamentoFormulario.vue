...
import {TipoAgendamento, TipoConsultaEnum, TipoProcedimentoEnum} from "@/types/typesAgendamento.ts";
import {LABELS_CONSULTA, LABELS_PROCEDIMENTO} from "@/constants/constAgenda.ts";
