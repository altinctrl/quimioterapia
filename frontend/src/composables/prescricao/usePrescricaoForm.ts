...
import {prescricaoFormSchema, type PrescricaoFormValues} from '@/schemas/prescricaoSchema'
import {TemplateCiclo} from "@/types/protocoloTypes.ts";
import {mesclarPrescricaoComTemplate} from "@/utils/prescricaoUtils.ts";
...
export function usePrescricaoForm() {
