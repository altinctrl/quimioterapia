...
import {pacienteFormSchema} from '@/schemas/esquemaPaciente.ts'
import {ContatoEmergencia, Paciente} from "@/types/typesPaciente.ts";

export function usePacienteFormulario() {
