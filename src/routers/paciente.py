...
from src.dependencies import get_paciente_provider, _get_paciente_postgres_provider
...
async def buscar_paciente_aghu(termo: str = Query(..., min_length=3),
        provider: PacienteProviderInterface = Depends(_get_paciente_postgres_provider)):
